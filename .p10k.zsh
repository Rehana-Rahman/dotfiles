# Generated by Powerlevel10k configuration wizard on 2025-10-31 at 21:24 IST.
...
function prompt_rayhana() {
  p10k segment -b 4 -f 0 -t 'rayhana'
}
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    rayhana         # <--- This shows your username (and host if wanted)
